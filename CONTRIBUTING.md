# Contributing to the MarkLogic Toolkit for Word

The Toolkit project welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use the Toolkit, please file an issue [here
on GitHub][issue tracker] or direct these to [Stack Overflow][stack overflow].
...
* **Toolkit Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/marklogic-community/toolkit-for-word/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/toolkit-for-word.git
$ cd toolkit-for-word
$ git remote add upstream git://github.com/marklogic-community/toolkit-for-word.git
```
...
Go to https://github.com/username/toolkit-for-word and select your feature branch. Click
...
[issue tracker]: https://github.com/marklogic-community/toolkit-for-word/issues
[stack overflow]: https://stackoverflow.com/tags/marklogic
